...
A Streamlit app to estimate earthworm area (and, soon, mass) from photos. Deployable on Streamlit Cloud and available [HERE](https://vmyrgiotis-earthworm-mass-estimator-streamlit-photo-app-gmcyje.streamlit.app)
